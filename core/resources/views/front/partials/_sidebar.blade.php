@if (isset($postPopulars))
		    ...
		    <div class="row">
		        <div class="col-xs-4">
		            <figure class="media__list__img">
		                <img src="{{ url("uploads/post-images/$postPopular->img") }}" alt="{{ $postPopular->title }}">
		            </figure>
		        </div>
		        <div class="col-xs-8">
	...
	<div class="media__big">
		...
		<img src="{{ url("uploads/post-images/$postHead->img") }}" alt="{{ $postHead->title }}">
	    </figure>
	    <article class="media__big__content media__big__content--small">
		<a href="blog/{{$postHead->cate->slug}}" class="media__big__cate media__big__cate--small media__big__cate--green">{{$postHead->cate->name}}</a>
